...
<Task>
陳腐化してしまった設計書を更新します
AIに向かって「この設計書更新ガイド使用して設計書Aを更新してください」というプロンプトを与えると設計書Aが更新されることを目指しています。
このガイド自体も、guide_files.mdとguide_rules.mdに従って、mdファイルとして作成すること

# 設計書更新ガイドの中身
- AIがこのガイドを参照して指定した設計書を更新できるないようであること
- 対象の設計書に関連する設計書とソースプログラムをすべて読込中身を理解する事
- guide_files.mdとguide_rules.mdに従って設計書の更新を行うように促す事
- チェック項目を設ける事
    - チェック項目
        - guide_files.mdとguide_rules.mdに従って書かれている事
        - 更新した設計書とソースプログラムの内容が一致している事
        - 関連ファイルセッションが正しく更新されている事
        - 更新履歴セッションが正しく更新されていること
</Task>
