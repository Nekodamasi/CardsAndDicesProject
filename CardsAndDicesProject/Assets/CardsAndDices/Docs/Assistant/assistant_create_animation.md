...
あなたのタスクは、クリーチャーカードがバフを受けた時のアニメーションを実装するために必要なC#ソースコードを生成し、関連するプロジェクトファイルを更新することです。
  ...
  - 縦にわずかにつぶれて、つぶれた分、下に少し移動します
  - その後、縦に伸びて、横も少しだけつぶれます、元の位置より少し上に移動します
  - ここまでで0.1秒のアニメーションです
  - 0.3秒ウエイトします
  - 0.1秒かけて、完全に元の位置とサイズに戻ります
  - サイズ変更や秒数は、AnimationProfileで管理します
  </animation_description>
