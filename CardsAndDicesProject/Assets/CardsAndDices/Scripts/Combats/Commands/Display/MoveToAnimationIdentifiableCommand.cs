...
namespace CardsAndDices
{
    ...
    /// </summary>
    public class MoveToAnimationIdentifiableCommand : IEvent
    {
        ...
        public MoveToAnimationIdentifiableCommand(CompositeObjectId executedObjectId, Vector3 targetPosition)
        {
