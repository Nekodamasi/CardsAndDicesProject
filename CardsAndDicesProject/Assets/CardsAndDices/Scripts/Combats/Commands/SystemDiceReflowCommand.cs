...
namespace CardsAndDices
{
    ...
    /// </summary>
    public class SystemDiceReflowCommand : IEvent
    {
        /// <summary>
        ...
        SystemDiceReflowCommand(Dictionary<CompositeObjectId, Vector3> diceMovements, IEvent nextCommand = null)
        {
