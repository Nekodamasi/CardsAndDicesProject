...
namespace CardsAndDices
{
    ...
    public class BuffAnimationStrategySO :  BaseAnimationStrategySO
    {
        ...
        public override Sequence ExecuteAsync(AnimationContext context)
        {
            ...
            sequence.OnComplete(() =>
            {
                context.IdentifiableCommandBus.Emit(new PlayVfxCommand(context.VfxDefinition, context.MoveTargetTransform.position, context.MoveTargetTransform.rotation));
            });
            return sequence;
        }
    }
