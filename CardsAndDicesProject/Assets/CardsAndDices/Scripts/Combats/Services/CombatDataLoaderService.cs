...
namespace CardsAndDices
{
    public class CombatDataLoaderService
    {
        ...
        public CombatData GetCombatData(WaveAreaId area, ChallengeRating challenge)
        {
            if (_combatScenarioRegistry == null)
            {
                Debug.LogError("CombatScenarioRegistry is not assigned.");
        ...
        public CombatData GetRandomCombatData(WaveAreaId area, ChallengeRating challenge)
        {
            if (_combatScenarioRegistry == null)
            {
                Debug.LogError("CombatScenarioRegistry is not assigned.");
