...
namespace CardsAndDices
{
    ...
    /// </summary>
    public class NextTurnPresenter : IDisposable, IIdentifiablePresenter
    {
        private readonly NextTurnInstance _instance;
        private readonly NextTurnBtnView _view;
        ...
        public NextTurnPresenter(NextTurnInstance instance, NextTurnBtnView view, GameEventBus eventBus)
        {
            _instance = instance;
            _view = view;
            _eventBus = eventBus;
