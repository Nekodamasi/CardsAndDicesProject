...
namespace CardsAndDices
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "AbilityDataEntity", menuName = "CardsAndDices/Combats/Data/EntityDefinition/AbilityDataEntity")]
    public class AbilityDataEntity : BaseEntityDefinition
    {
        [Tooltip("この能力の効果範囲")]
