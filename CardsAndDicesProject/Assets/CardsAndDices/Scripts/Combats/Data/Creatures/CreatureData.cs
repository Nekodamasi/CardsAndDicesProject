...
namespace CardsAndDices
{
    ...
    public class CreatureData
    {
        ...
        /// クリーチャーが持つ固有能力のリスト。
        /// </summary>
        public List<AbilityDataEntity> Abilities;
        ...
        public CreatureData(CreatureIdEntity creatureId, int attack, int health, int shield, int cooldown, int energy, List<AbilityDataEntity> abilities, EffectTargetType mainAttackScoresType, int hitsPerMainAttack, AreaOfEffect mainAttackAoE)
        {
