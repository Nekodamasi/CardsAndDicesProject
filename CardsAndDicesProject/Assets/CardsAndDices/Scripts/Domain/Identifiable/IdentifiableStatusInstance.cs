...
namespace CardsAndDices
{
    ...
    public class IdentifiableStatusInstance
    {
        ...
        public IdentifiableStatusInstance(CompositeObjectId objectId, IdentifiableCommandBus identifiableCommandBus, IdentifiableUIStateMachine identifiableUIStateMachine)
        {
        ...
        public void Dispose()
        {
            _identifiableCommandBus.Off<IdentifiableChangeStatusCommand>(OnIdentifiableChangeStatus);
        }
