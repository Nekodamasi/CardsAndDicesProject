...
namespace CardsAndDices
{
    ...
    /// ステータス変更コマンド
    /// </summary>
    public class IdentifiableChangeStatusCommand : ICommand
    {
        ...
        public IdentifiableChangeStatusCommand(CompositeObjectId executedObjectId, IdentifiableStatus newStatus)
        {
