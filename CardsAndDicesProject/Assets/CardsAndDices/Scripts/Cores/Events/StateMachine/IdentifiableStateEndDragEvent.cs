...
{
    /// <summary>
    /// IdentifiableUIStateMachineが発行するEndDragイベント。
    /// </summary>
    public class IdentifiableStateEndDragEvent : IEvent
    {
        ...
        public IdentifiableStateEndDragEvent(CompositeObjectId executedObjectId)
        {
