...
{
    /// <summary>
    /// IdentifiableUIStateMachineが発行するBeginDragイベント
    /// </summary>
    public class IdentifiableStateBeginDragEvent : IEvent
    {
        ...
        public IdentifiableStateBeginDragEvent(CompositeObjectId executedObjectId)
        {
