...
{
    /// <summary>
    /// IdentifiableUIStateMachineが発行するUnHoverイベント。
    /// </summary>
    public class IdentifiableStateUnhoverEvent : IEvent
    {
        ...
        public IdentifiableStateUnhoverEvent(CompositeObjectId executedObjectId)
        {
