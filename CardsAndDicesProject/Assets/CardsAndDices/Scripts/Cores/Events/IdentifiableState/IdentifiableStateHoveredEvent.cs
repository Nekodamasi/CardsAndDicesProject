...
{
    /// <summary>
    /// IdentifiableUIStateMachineが発行するHoveredイベント。
    /// </summary>
    public class IdentifiableStateHoveredEvent : IEvent
    {
        ...
        public IdentifiableStateHoveredEvent(CompositeObjectId executedObjectId)
        {
