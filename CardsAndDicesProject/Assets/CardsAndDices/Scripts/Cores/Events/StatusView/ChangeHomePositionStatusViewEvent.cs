...
namespace CardsAndDices
{
    ...
    /// ホームポジション変更コマンド
    /// </summary>
    public class ChangeHomePositionStatusViewEvent : IEvent
    {
        ...
        public ChangeHomePositionStatusViewEvent(CompositeObjectId executedObjectId, Vector3 targetPosition)
        {
