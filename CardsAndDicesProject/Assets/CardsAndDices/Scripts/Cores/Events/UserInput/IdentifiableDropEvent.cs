...
{
    /// <summary>
    /// UI要素のドラッグ操作が開始された時のコマンド。
    /// </summary>
    public class IdentifiableDropEvent : IEvent
    {
        ...
        public IdentifiableDropEvent(CompositeObjectId executedObjectId, CompositeObjectId targetObjectId)
        {
