...
namespace CardsAndDices
{
    ...
    public class VfxManager : ScriptableObject, IDisposable
    {
        ...
        [Inject]
        public void Initialize(SoundManager soundManager, GameEventBus eventBus)
        {
            ClearCollections();
            ...
            _eventBus = eventBus;
            _eventBus.On<PlayVfxEvent>(OnPlayVfx);
        }
        ...
        private async void OnPlayVfx(PlayVfxEvent evt)
        {
            await PlayVfxAsync(evt.VfxDefinition, evt.Position, evt.Rotation);
        }
