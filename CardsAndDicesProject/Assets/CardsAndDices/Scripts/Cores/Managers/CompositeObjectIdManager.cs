...
namespace CardsAndDices
{
	...
	public class CompositeObjectIdManager : ScriptableObject
	{
		...
		private CompositeObjectRegistry _compositeObjectRegistry;
		...
		/// </summary>
		[Inject]
        public void Initialize(CompositeObjectRegistry compositeObjectRegistry)
        {
		...
		public CompositeObjectId CreateId(CompositeObjectIdTypeEntity objectType, CompositeObjectId owner = null)
		{
			...
			var id = new CompositeObjectId(currentId, objectType, owner);
			_compositeObjectRegistry.Register(id);
			return id;
		}
